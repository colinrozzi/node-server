...
/*
    ...
    right now, can see the sm through http requests
    need to have the network operate

    clean up code
    very messy, split into some nice places

    figure out how to add transactions from web-page
